...
- **Tables**:
  ...
  - Messages — `tblClvD9i8QPZJwVS` (client ↔ team thread; Preview `fldrHdHQd9ojanUBZ`, Client `fldRxcp88EqjMHLD8`, Sender `fld2XdCzogwngsNad` (Team/Client), Body `fldmRrouQj3T5wu0o`, Sent at `fldQ7V2ZgXtdvp0qH`, Read by client `fldkXsna3wh6oY8AH`, Read by team `fldM1xwnYiYce8ql2`; read flags drive the unread badges on both sides)
