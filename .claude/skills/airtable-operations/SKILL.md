...
- **Tables**:
  ...
  - Messages — `tblClvD9i8QPZJwVS` (client ↔ team ↔ Luna thread; Preview `fldrHdHQd9ojanUBZ`, Client `fldRxcp88EqjMHLD8`, Sender `fld2XdCzogwngsNad` (Team/Client/Luna), Body `fldmRrouQj3T5wu0o`, Sent at `fldQ7V2ZgXtdvp0qH`, Read by client `fldkXsna3wh6oY8AH`, Read by team `fldM1xwnYiYce8ql2`, Attachments `fldCPFM65ArYJMsDB`; read flags drive the unread badges, Luna replies are read on both sides)
  - Knowledge Base — `tbl02IR9iQtRxAV28` (what Luna answers from; Title `fldZGLCJV2LXlBSpe`, Body `fldCExTddFzwR6ijR`, Keywords (comma triggers) `fldGICA3THYD3Kahv`, Category `fld6rQqkyObQ9xw44`, Active `fld5wtLBsTHepOtWI`; curated at /admin/knowledge or directly here; 10 articles seeded 10 Jun 2026)
